...
$select_message = $conn->prepare("SELECT * FROM `orders` WHERE user_id = ?");
...
<body>
  ...
  <div class="banner">
    <div class="detail">
      <h1>my profile</h1>
      <p> ipsum dolor sit amet consectetur, adipisicing elit. Obcaecati, sit enim provident doloremq<br>
