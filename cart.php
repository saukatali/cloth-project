...
<body>
  ...
  <div class="banner">
    <div class="detail">
      <h1>my cart</h1>
      <p>Your shopping cart, your style hub! Review your selected items, update quantities, <br>and proceed to checkout
        whenever you’re ready. Don’t wait your fashion favorites are just a step away</p>
  ...
  <div class="products">
    <div class="heading">
      <h1>product added in your cart</h1>
          ...
          if ($select_products->rowCount() > 0) {
            ...
            <form action="" method="post" class="box <?php if ($fetch_products['stock'] == 0) {
              ...
              <div class="content cart-content">
                ...
                <div class="flex-btn">
                  <input type="number" name="qty" required min="1" max="99" value="<?= $fetch_cart['qty']; ?>" maxlength="2"
                    class="qty">

                  <button type="submit" name="update_cart" class="bx bxs-edit fa-solid fa-pen-to-square"
                    style="box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.40);">
                  </button>
