...
<body>
  ...
  <div class="banner">
    <div class="detail">
      <h1>my wishlist</h1>
      <p>Save your favorites for later! Add your desired items to your wishlist and <br>revisit them anytime. Don’t miss
        out on the styles you love shop from your wishlist whenever you’re ready</p>
            ...
            <form action="" method="post" class="box <?php if ($fetch_products['stock'] == 0) {
              ...
              <div class="content">
                ...
                <div class="flex">
                  ...
                  <a href="checkout.php?get_id=<?= $fetch_products['id'] ?>" class="btn" style="width: 100% !important;">buy
                    now</a>
                </div>
              </div>
