    ...
    if (isset($_GET['get_id'])) {
      ...
      if ($get_product->rowCount() > 0) {
        while ($fetch_p = $get_product->fetch(PDO::FETCH_ASSOC)) {
          ...
          $insert_order = $conn->prepare("INSERT INTO `orders` (user_id, seller_id, name, number, email, address, address_type, method, product_id, price, qty) VALUES(?,?,?,?,?,?,?,?,?,?,?)");

          $insert_order->execute([$user_id, $seller_id, $name, $number, $email, $address, $address_type, $method, $fetch_p['id'], $fetch_p['price'], 1]);
  ...
  <div class="checkout">
    ...
    <div class="row">
          ...
          <div class="flex">
            ...
            <div class="col">
              <div class="input-field">
                ...
                <input type="text" name="flat" placeholder="e.g flat & bilding" maxlength="50" class="box" required>
              </div>
              ...
              <div class="input-field">
                ...
                <input type="number" name="pin" placeholder="e.g 110099" maxlength="6" class="box" required>
              </div>
            </div>
          </div>
      ...
      <div class="summary">
        ...
        <div class="box-container">
          ...
          if (isset($_GET['get_id'])) {
            ...
            while ($fetch_get = $select_get->fetch(PDO::FETCH_ASSOC)) {
              ...
              ?>
              <div class="flex">
                <img src="uploaded_files/<?= $fetch_get['thumb_one']; ?>" class="image">
                <div>
        ...
        <div class="grand-total"><span>total amount payble:</span>₹<?= $grand_total; ?>/-</div>
      </div>
    </div>
  </div>
