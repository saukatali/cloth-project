...
<body>
  ...
  <div class="banner">
    <div class="detail">
      <h1>dashboard</h1>
      <p>Welcome to your personalized dashboard! Access everything you need in one place track <br>your orders, manage
        your wishlist, update account details, view purchase history, <br>and stay updated on exclusive offers. Your
        shopping
        experience, simplified!</p>
  ...
  <div class="dashboard">
    ...
    <div class="box-container">
      ...
      <div class="box">
        ...
        <p>confirm orders</p>
        <a href="confirm.php" class="btn">confirm orders</a>
      </div>
    </div>
  </div>
