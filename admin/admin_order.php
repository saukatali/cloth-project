...
<body>
  ...
  <div class="banner">
    <div class="detail">
      <h1>my orders</h1>
      <p>Track and manage your orders with ease! View your order history, <br>check the status of current orders,
        download invoices, <br>and get updates on delivery—all in one convenient place.</p>
