...
<body>
  ...
  <div class="banner">
    <div class="detail">
      <h1>add products</h1>
      <p>Add your products to showcase your unique collection! Easily upload product images, <br>set prices, write
        descriptions, and manage stock levels. Keep your inventory fresh and ready to impress your customers!</p>
        ...
        <div class="flex">
          <div class="col">
            ...
            <div class="input-field">
              ...
              <input type="number" name="stock" maxlength="10" min="0" max="9999999999" placeholder="add product stock"
                required class="box">
            </div>
          </div>
