...
if (isset($_POST['update_order'])) {
  ...
  $update_pay->execute([$update_payment, $order_status, $order_id]);
...
<body>
  ...
  <div class="banner">
    <div class="detail">
      <h1>my orders</h1>
      <p>Keep track of all your purchases in one place! View order details, <br>check delivery status, manage returns or
        exchanges, <br>and download invoices effortlessly. Stay updated on every step of your shopping journey.</p>
  ...
  <div class="order-container">
    ...
    <div class="box-container">
      ...
      if ($select_orders->rowCount() > 0) {
        while ($fetch_orders = $select_orders->fetch(PDO::FETCH_ASSOC)) {
          ...
          <div class="box">
            ...
            <form action="" method="post">
              ...
              <select name="order_status" class="box" style="width:90%;">
              ...
              <div class="flex-btn">
                ...
                <button type="submit" name="delete" onclick="return confirm('want to delete this order');"
                  class="btn">delete order</button>
              </div>
            </form>
        ...
        echo '
            <div class="empty">
              <p>no orders takes placed yet!</p>
            </div>
          ';
      }
      ?>
