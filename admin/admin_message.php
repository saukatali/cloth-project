...
<body>
  ...
  <div class="banner">
    <div class="detail">
      <h1>messages</h1>
      <p>Stay connected with us! Check your messages for updates on your orders, special offers, <br>promotions, and
        important notifications. Never miss a deal or important info—everything you need is right here.</p>
        ...
        while ($fetch_msg = $select_msg->fetch(PDO::FETCH_ASSOC)) {
          ...
          <div class="box">
            ...
            <form action="" method="post">
              ...
              <button type="submit" name="delete" onclick="return confirm('want to delete this message');"
                class="btn">delete message</button>
            </form>
          </div>
          <?php
        }
